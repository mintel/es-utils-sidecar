...
RUN apk --no-cache add build-base tar musl-utils openssl-dev linux-headers openssl-dev libssl1.0 gcc libffi py-cffi python-dev libffi-dev py-openssl curl bash \
